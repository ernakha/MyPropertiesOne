                                ...
                                <div class="filter-group">
                                    ...
                                    <div class="filter-item">
                                        <button type="submit" class="btn btn-primary"
                                            style="display: block; margin: auto;">Cari</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="container">
                    ...
                    <ul class="grid-list">
                        @foreach ($properti as $item)
                                    ...
                                    <a href="{{ route('detail', ['slug' => $item->slug]) }}" class="card-link">
                                        <div class="course-card">
                                            ...
                                            <div class="card-content" style="display: flex; flex-direction: column;">
                                                ...
                                                <div class="card-meta-list" style="margin-bottom: 10px;">
                                                    ...
                                                    @if ($item->harga)
                                                        <div class="card-price"
                                                            style="font-size: 1.5rem; font-weight: bold; margin-bottom: 5px; margin-right: 150px;">
                                                            <span
                                                ...
                                                <h3 class="h3" style="margin-bottom: 5px;">
                                                    <!-- Adjust spacing here -->
                                                    {{ Str::limit($item->judul, 20) }}
                                                </h3>

                                                @if ($item->alamat)
                                                    <div class="rating-wrapper" style="margin-bottom: 15px;">
                                                        <!-- Adjust spacing here -->
                                                ...
                                                <ul class="card-footer" style="margin-top: auto;">
                                                    <!-- Make this section grow to fill space -->
                                                    <li class="card-meta-item">
                                                        @if ($item->kt)
                                                            <ion-icon name="bed-outline"></ion-icon>
                                                            <span class="card-meta-text"
                                                                style="font-size: smaller">{{ $item->kt }} Kamar
                                                                Tidur</span>
                                                        @endif
                                                    </li>
                                                    <li class="card-meta-item">
                                                        @if ($item->km)
                                                            ...
                                                            <span class="card-meta-text"
                                                                style="font-size: smaller">{{ $item->km }} Kamar
                                                                Mandi</span>
                                                        @endif
                                                    </li>
                                                    <li class="card-meta-item">
                                                        @if ($item->lt)
                                                            ...
                                                            <span class="card-meta-text"
                                                                style="font-size: smaller">{{ $item->lt }} m
                                                                <sup>2</sup></span>
                                                        @endif
                                                    </li>
                                                </ul>
                            ...
                            @else
                                <li>
                                    <div class="empty-space" style="height: 1000px;"></div>
                                    <!-- Menjaga ruang kosong -->
                                </li>
                            @endif
                        @endforeach
                    </ul>
    ...
    <footer class="footer" id="footer">
        <div class="container">
            <div class="footer-bottom">
                <p class="copyright">
                    Copyright <span id="currentYear" style="display: inline;"></span> MyPropertiesOne. Ada pertanyaan?
                    Hubungi Kami di <a href="https://wa.me/6283876767059" class="copyright-link"
                        target="_blank">WhatsApp</a> atau <a href="https://www.instagram.com/mypropertiesone/"
                        class="copyright-link" target="_blank"> Instagram</a>
                </p>
            </div>
        </div>
    </footer>
